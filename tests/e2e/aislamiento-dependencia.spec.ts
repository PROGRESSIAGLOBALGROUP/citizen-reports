...
async function waitForServer(page: Page, maxAttempts = 10): Promise<void> {
...
// Helper: Login
async function login(page: Page, user: typeof TEST_ADMIN): Promise<string> {
...
async function loginAndNavigate(page: Page, user: typeof TEST_ADMIN): Promise<void> {
  ...
  // Navigate to frontend and set token in localStorage
